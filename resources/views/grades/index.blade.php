...
@section('title', 'Grades - Academic Information System')
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        @if(auth()->user()->isLecturer())
            <a href="{{ route('grades.create') }}" class="btn btn-sm btn-primary">
                <i class="fas fa-plus me-1"></i> Add New Grades
            </a>
        @endif
    </div>
</div>
            ...
            <form action="{{ route('grades.index') }}" method="GET" class="row g-3">
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search by student or course" name="search" value="{{ request('search') }}">
